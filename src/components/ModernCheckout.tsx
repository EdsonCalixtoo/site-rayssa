                    ...
                    <div className="bg-blue-50 border-2 border-blue-200 rounded-xl p-4">
                      ...
                      <div className="space-y-2 max-h-64 overflow-y-auto">
                        {carriers.map((carrier) => {
                          ...
                          const companyName = carrier.company?.name || carrier.name || 'Transportadora';
                    ...
                    <div className="bg-green-50 border-2 border-green-200 rounded-xl p-4">
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-2">
                          ...
                          <div>
                            <span className="font-bold text-green-900 block">{selectedCarrier.company?.name || selectedCarrier.name || 'Transportadora'}</span>
                            <span className="text-xs text-green-700">Prazo: {selectedCarrier.deadline} dia(s)</span>
                          </div>
                        </div>
                        <span className="text-xl font-bold text-green-600">
                          {Number(shippingCost || 0).toLocaleString('pt-BR', {
                            style: 'currency',
                            currency: 'BRL',
                          })}
                        </span>
