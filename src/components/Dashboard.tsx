...
import { X, Package, Clock, CheckCircle, XCircle, LogOut, LayoutDashboard, ShoppingBag, Users, TrendingUp, Truck, Edit2, CreditCard, QrCode, DollarSign, Calendar, Settings } from 'lucide-react';
  ...
  return (
    <div className="fixed inset-0 bg-gradient-to-br from-slate-900/95 via-slate-800/95 to-slate-900/95 backdrop-blur-sm z-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl w-full max-w-7xl max-h-[90vh] overflow-hidden flex flex-col shadow-2xl">
        ...
        <div className="bg-gradient-to-r from-slate-800 to-slate-700 px-8 py-2">
